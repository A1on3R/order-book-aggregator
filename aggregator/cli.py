...
def main():
    ...
    buy_price, buys = get_price_for_quantity(merged["asks"], args.quantity)
    sell_price, sells = get_price_for_quantity(merged["bids"], args.quantity)
    ...
    if buy_price is not None:
        ...
        for o in buys:
            print(f"    - {o['quantity']} BTC at ${o['price']} from {o['source']}")
    else:
